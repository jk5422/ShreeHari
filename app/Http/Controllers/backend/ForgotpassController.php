...
class ForgotpassController extends Controller
{
    ...
    function sendemail(Request $req)
    {
        if($req->input('fusername')!="")
        {
            ...
            if($cnt>=1)
            {
                ...
                $mail=mail($req->input('fusername'),'Forgot Patient Password For ShreeHari','Dear Patients your one time otp is '.$otp.'. Never share otp with anyone else.','From: koladiyajaimin6@gmail.com');
    ...
    function resendemail(Request $req)
    {
        ...
        function password_generate($chars)
                ...
                $mail=mail($req->post('pemail'),'Forgot Patient Password For ShreeHari','Dear Patients your one time otp is '.$otp.'. Never share otp with anyone else.','From: koladiyajaimin6@gmail.com');
    ...
    function drsendemail(Request $req){
        if($req->input('demail')!="")
        {
            ...
            if($cnt>=1)
            {
                ...
                $mail=mail($req->input('demail'),'Forgot Doctor Password For ShreeHari','Dear Respected Doctors your one time otp is '.$otp.'. Never share otp with anyone else.','From: koladiyajaimin6@gmail.com');
    ...
    function drresendemail(Request $req)
    {
        ...
        function password_generate($chars)
                ...
                $mail=mail($req->post('demail'),'Forgot Doctor Password For ShreeHari','Dear Respected Dotors your one time otp is '.$otp.'. Never share otp with anyone else.','From: koladiyajaimin6@gmail.com');
