        ...
        <div class="container-fluid ">
            ...
            <div class="container-inq">
                ...
                <div class="d-flex">
                    ...
                    <input type="hidden" class="pid" name="pid" value="{{$result[0]->pid}}">
                    <tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('updateappoinment') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="date" name="uapdate"  class="form-control mydate" onchange="upgetday(this.value)" required>
                            <span id="msg"></span>
                        </div>
                        <div class="form-group">
